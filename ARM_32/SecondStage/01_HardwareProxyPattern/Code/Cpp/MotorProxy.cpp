...
unsigned int MotorProxy::getMotorSpeed() {
	MotorData mData;
...
unsigned int MotorProxy::getMotorState() {
	MotorData mData;
...
void MotorProxy::setMotorSpeed(const DirectionType direction, unsigned int speed) {
	MotorData mData;
...
unsigned int MotorProxy::marshal(const MotorData& mData) {
...
MotorData MotorProxy::unmarshal(unsigned int encodedMData) {
	MotorData mData;
	int temp;
